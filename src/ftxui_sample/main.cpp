...
// configuration step. It creates a namespace called `DrugsWars`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", DrugsWars::cmake::project_name, DrugsWars::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", DrugsWars::cmake::project_version);
      return EXIT_SUCCESS;
    }
